...
/**
 * Servlet implementation class G2ExamServlet
 */
@WebServlet("/G2ExamServlet")
public class G2ExamServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public G2ExamServlet() {
        super();
